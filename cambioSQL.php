    ...
    <body>
        ...
        if( isset($_POST["matricula"]) ){
            ...
            ?>           
                    ...
                    <br>
                    <h2>Búsqueda del alumno a actualizar por matricula</h2>
                   <br>
                   <form action="cambioSQL.php" method="post" enctype="multipart/form-data" name="personal" id="personal" class="needs-validation" novalidate >              
                            <div class="form-group">
                                <label for="matricula" >Matricula:</label>
